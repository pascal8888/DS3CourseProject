...
print("Data has been processed. finaldata.txt has been written to the working directory. It contains the tidy data set of the mean of each subject's activities across each feature measurement. The data frame has been loaded for viewing. To display the text file in R, copy and execute the following function at the console >> View(read.table("finaldata.txt",header=T)) <<.")
